...
const ProfessionalDocumentView = forwardRef<HTMLDivElement, ProfessionalDocumentViewProps>(
  ({ document, brandSettings }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className="document-print-page mx-auto w-full max-w-[900px] rounded-xl border border-[#e5e7eb] bg-white px-10 py-10 text-[#0f172a] shadow-[0_8px_30px_rgba(15,23,42,0.06)] print:rounded-none print:border-0 print:shadow-none"
      >
        {/* ─── Header ─── */}
